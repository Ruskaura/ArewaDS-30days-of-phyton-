...
area_of_rectangle = length * r_width
...
# Calculates the number of seconds one has lived by the years they live
years_lived = float(input("Enter the number of years you have lived:"))
seconds_lived = 2628000 * 12 * years_lived
